...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\asubject\x18\x01 \x01(\tR\asubject2L\n" +
...
var file_proto_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthenticationService.Verify:input_type -> auth.VerifyRequest
	1, // 1: auth.AuthenticationService.Verify:output_type -> auth.VerifyResponse
